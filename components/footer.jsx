    ...
    return (
        ...
        <div className="content " style={{
            ...
            <ul className="box" style={{  width: ' calc(100% / 5 - 10px)'}}>
                ...
                <li><a href="/aboutUs" className='text-base hover:underline hover:underline-offset-4 text-gray-300 font-medium' style={{transition:'all 0.5s ease'}}>About us</a></li>
        ...
        <div className="bottom-details w-full py-2 px-4 bg-zinc-600">
            <div className="bottom_text m-auto flex-between">
                ...
                <a className='opacity-90 text-slate-50  hover:underline px-4 hover:opacity-100'  href="/">MedDevs</a>
                All rights reserved
            </span>
